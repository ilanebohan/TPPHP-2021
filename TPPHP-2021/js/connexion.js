...
$("#login").submit(function( e ){
	...
	if($("#login").valid())
	{
		...
		switch($("input[type=radio][name=rblogin]:checked").attr("value"))
		{
			case 'rbj': $categ = 3; break;
			case 'rbr': $categ = 2; break;
			case 'rba': $categ = 1; break;
		}
		var formData = {
...
$("#login").validate({
	...
	messages: {
	  ...
	  mp: {
		...
		minlength: "Le mot de passe doit faire au minimum 2 caractères."
	  },
	  rblogin: {
